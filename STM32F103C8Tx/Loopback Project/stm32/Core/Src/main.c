...
int main(void)
{
  ...
  TxHeader.DLC = 1;		// 전송되는 데이터 프레임의 길이 정하기
  TxHeader.ExtId = 0;
...
static void MX_CAN_Init(void)
{
  ...
  canfilterconfig.FilterBank = 10;  // 0 ~ SlaveStartFilterBank
  ...
  canfilterconfig.SlaveStartFilterBank = 13;  // 13~27 : slave CAN (CAN 2) OR 0~12 : CAN1
