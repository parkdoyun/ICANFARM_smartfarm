...
QT_MOC_LITERAL(14, 150, 15), // "sendMqtt2Server"
QT_MOC_LITERAL(15, 166, 11), // "std::string"
QT_MOC_LITERAL(16, 178, 5), // "topic"
QT_MOC_LITERAL(17, 184, 3) // "msg"
    ...
    "serial_port_\0sendMqtt2Server\0std::string\0"
    "topic\0msg"
};
...
static const uint qt_meta_data_Thread[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 9, 0x80000000 | 15, 0x80000000 | 15,   10,   16,   17,
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->sendMqtt2Server((*reinterpret_cast< mqtt::async_client*(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2])),(*reinterpret_cast< const std::string(*)>(_a[3]))); break;
        default: ;
        }
