...
/**
  ...
  * All rights reserved.
  *
  * This software is licensed under t                            erms that can be found in the LICENSE file
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : B1_Pin PC8_CANL_Pin PC9_CANH_Pin */
  GPIO_InitStruct.Pin = B1_Pin|PC8_CANL_Pin|PC9_CANH_Pin;
